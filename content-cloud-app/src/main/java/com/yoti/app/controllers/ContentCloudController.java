...
public class ContentCloudController {
    ...
    public ResponseEntity<RetrieveMessageResponse> retrieveDataFromContentCloud(@Valid @RequestBody ContentCloudModel<RetrieveMessageRequest> messageRequest) {
    ...
    public ResponseEntity<Boolean> moveDataToBin(@Valid @RequestBody ContentCloudModel<BinRequest> binRequest) {
    ...
    public ResponseEntity<Boolean> removeDataToBin(@Valid @RequestBody ContentCloudModel<BinRequest> binRequest) {
    ...
    public ResponseEntity<Boolean> restoreDataFromBin(@Valid @RequestBody ContentCloudModel<BinRequest> binRequest) {
    ...
    public ResponseEntity<Boolean> emptyBinData(@Valid @RequestBody ContentCloudModel<BinRequest> binRequest) {
